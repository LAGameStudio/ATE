...
#define MY_STEAM_APPID ((uint32)738830)  /* Just a hint */
#define STEAM_APP_GAMEDIR "fringes"
#define MINIDUMP_CONTENT  "Minidump comment: Fringes.exe\n" 
...
MANY(SteamAchievementDefinition,SteamAchievementDefinitionHandle,SteamAchievementDefinitionHandles,"SteamAchievementDefinition",SteamAchievementDefinitions,{})
