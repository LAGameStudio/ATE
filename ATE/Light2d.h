...
public:
 ...
 virtual void Render() {
  ...
  shadows2dShader.UpdateUniforms(); 
  glBegin(GL_QUADS);
  glTexCoord2f(0.0,0.0f); glVertex2i( 0, 0 );
  glTexCoord2f(0.0,1.0f); glVertex2i( 0, display.h );
  glTexCoord2f(1.0,1.0f); glVertex2i( display.w, display.h );
  glTexCoord2f(1.0,0.0f); glVertex2i( display.w, 0 );
  glEnd();
  shadows2dShader.disableShader();
 }
...
public:
 ...
 void Render() {
  ...
  lightsnoradius2dShader.UpdateUniforms();
  glBegin(GL_QUADS);
  glTexCoord2f(0.0,0.0f); glVertex2i( 0, 0 );
  glTexCoord2f(0.0,1.0f); glVertex2i( 0, display.h );
  glTexCoord2f(1.0,1.0f); glVertex2i( display.w, display.h );
  glTexCoord2f(1.0,0.0f); glVertex2i( display.w, 0 );
  glEnd();
  lightsnoradius2dShader.disableShader();
 }
 virtual void Between() {}
 void MoveBy( float x, float y ) {
  for ( int i=0; i<GPUMULTILIGHTLIMIT; i++ ) {
...
public:
 ...
 void Render() {
  ...
  lightsnocolor2dShader.UpdateUniforms();
  glBegin(GL_QUADS);
  glTexCoord2f(0.0,0.0f); glVertex2i( 0, 0 );
  glTexCoord2f(0.0,1.0f); glVertex2i( 0, display.h );
  glTexCoord2f(1.0,1.0f); glVertex2i( display.w, display.h );
  glTexCoord2f(1.0,0.0f); glVertex2i( display.w, 0 );
  glEnd();
  lightsnocolor2dShader.disableShader();
 }
 virtual void Between() {}
 void MoveBy( float x, float y ) {
  for ( int i=0; i<GPUMULTILIGHTLIMIT; i++ ) {
...
public:
 ...
 void Render() {
  ...
  lightspulsing2dShader.UpdateUniforms();
  glBegin(GL_QUADS);
  glTexCoord2f(0.0,0.0f); glVertex2i( 0, 0 );
  glTexCoord2f(0.0,1.0f); glVertex2i( 0, display.h );
  glTexCoord2f(1.0,1.0f); glVertex2i( display.w, display.h );
  glTexCoord2f(1.0,0.0f); glVertex2i( display.w, 0 );
  glEnd();
  lightspulsing2dShader.disableShader();
 }
 virtual void Between() {}
 void MoveBy( float x, float y ) {
  for ( int i=0; i<GPUMULTILIGHTLIMIT; i++ ) {
