...
public:
 ...
 void GetState(int x, int y, int w, int h, bool dontIgnoreNextRelease=true);
 ...
 double decimal( const char *label, double value, double lowest, double highest, double delta, FastExtents e, int characters=7, bool deltaOk=true, bool limitOk=false );
 double decimal( const char *label, double value, double lowest, double highest, double delta, int x, int y, int w, int h, int characters=7, bool deltaOk=true, bool limitOk=false );
 ...
 ////
 double hslider( const char *label, double value, double lowest, double highest, int x, int y, int w, int h=16, bool simple=false, bool nolabels=false);
 int hslider( const char *label, int value, int lowest, int highest, int x, int y, int w, int h=16, bool simple=false, bool nolabels=false);
 ...
 int togglelist( TexFont *font, const char * label, Strings * values, int x, int y, int cw, int lines, int *scroll=null, int charactersLimit=32, bool reorderable=false );
 ...
 ////
 bool editing( int value ) { return value == INT_MAX; }
 bool editing( double value ) { return value == 123456789.87654321; }
 void xy( Cartesiand *inOut, int x, int y, double xymin=-10000, double xymax=10000, const char *label="", const char *x_label="x", const char *y_label="y", int characters=7, bool limitOk=false );
 void xy( Cartesian *inOut, int x, int y, int xymin=-10000, int xymax=10000, const char *label="" );
 void xy( const char *label, const char *label1, const char *label2, Cartesian *inOut, int x, int y, int xymin=-10000, int xymax=10000 );
 ...
 void wh( Cartesiand *inOut, int x, int y, double xymin=-10000, double xymax=10000, const char *label="", const char *w_label="w", const char *h_label="h", int characters=7, bool limitOk=false );
 ...
 GLImage *imagePicker(const char *label, GLImage *value,int x, int y, int w=64, int h=64, int bh=16,bool xToNull=false);
 ////
