...
struct b2Jacobian
{
	...
	void SetZero();
	void Set(const b2Vec2& x1, float a1, const b2Vec2& x2, float a2);
	float Compute(const b2Vec2& x1, float a1, const b2Vec2& x2, float a2);
};
...
protected:
	...
	virtual bool SolvePositionConstraints(float baumgarte) = 0;
...
inline void b2Jacobian::Set(const b2Vec2& x1, float a1, const b2Vec2& x2, float a2)
{
	linearA = x1; angularA = a1;
	linearB = x2; angularB = a2;
}

inline float b2Jacobian::Compute(const b2Vec2& x1, float a1, const b2Vec2& x2, float a2)
{
