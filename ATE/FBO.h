 ...
 */
 ...
 // If the number returned is ~"30,30,30,255" this means you have forgotten to bind before reading.
 ...
 void RenderReversed( int x, int y, int x2, int y2 ) {
  ...
  glTexCoord2f(0.0f,0.0f);     glVertex2i(x2,y);
  glTexCoord2f(0.0f,1.0f);     glVertex2i(x2,y2);
  glTexCoord2f(1.0f,1.0f);     glVertex2i(x,y2);
  glEnd();
  glDisable(GL_BLEND);
  glDisable(GL_TEXTURE_2D);
  GL_Assert("Framebuffer::Render() Post" );
 ...
 void RenderUpsideDown( int x, int y, int x2, int y2 ) {
  ...
  glTexCoord2d(1.0,1.0);     glVertex2i(x2,y);
  glTexCoord2d(1.0,0.0);     glVertex2i(x2,y2);
  glTexCoord2d(0.0,0.0);     glVertex2i(x,y2);
  glEnd();
  glDisable(GL_BLEND);
  glDisable(GL_TEXTURE_2D);
  GL_Assert("Framebuffer::Render() Post" );
 ...
 void Render( Cartesian *extents ) {
  ...
  glBindTexture(GL_TEXTURE_2D, texture);
  glBegin(GL_QUADS);
  glTexCoord2d(0.0,1.0);   glVertex2i(extents->x,extents->y);
  glTexCoord2d(1.0,1.0);   glVertex2i(extents->x2,extents->y);
  glTexCoord2d(1.0,0.0);   glVertex2i(extents->x2,extents->y2);
  glTexCoord2d(0.0,0.0);   glVertex2i(extents->x,extents->y2);
  glEnd();   
  glDisable(GL_BLEND);
  glDisable(GL_TEXTURE_2D);
 }
 ...
 void Render( Cartesiand *extents ) {
  ...
  glBindTexture(GL_TEXTURE_2D, texture);
  glBegin(GL_QUADS);
  glTexCoord2d(0.0,1.0); glVertex2d(extents->x,extents->y);
  glTexCoord2d(1.0,1.0); glVertex2d(extents->x2,extents->y);
  glTexCoord2d(1.0,0.0); glVertex2d(extents->x2,extents->y2);
  glTexCoord2d(0.0,0.0); glVertex2d(extents->x,extents->y2);
  glEnd();   
  glDisable(GL_BLEND);
  glDisable(GL_TEXTURE_2D);
 }
 ...
 void Renderf( float x, float y, float x2, float y2 ) {
  ...
  glTexCoord2d(1.0,1.0);    glVertex2f(x2,y);
  glTexCoord2d(1.0,0.0);    glVertex2f(x2,y2);
  glTexCoord2d(0.0,0.0);    glVertex2f(x,y2);
  glEnd();
...
// 1k and 2k FBOs
extern FBOColorDepthStencil fboCDS1024, fboCDS1024b, fboCDS1024c, fboCDS2048, fboCDS2048b;
