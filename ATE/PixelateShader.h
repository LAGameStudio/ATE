...
//   string("uniform vec2 pixel;\n")+
   string("void main()\n")+
   string("{\n")+
   string(" vec2 uv = gl_TexCoord[0].xy * resolution.xy;\n")+
   string(" gl_FragColor = texture2D(sceneTex, uv);\n")+
   string("}\n")
  ;
...
public:
 ...
 void Init() {
  ...
  string frag=
   ...
   +string("	vec2 tex_pixel = sz * v_vTexcoord - step.xy / 2;\n")
   +string("	\n")
   ...
   +string("	\n")
   +string("	gl_FragColor = v_vColour * (c1 + c2 + c3 + c4);\n")
   +string("}\n")
  ;
...
public:
 ...
 void Init() {
  ...
  string frag=
   ...
   +string("varying vec4 v_vColour;\n")
   +string("void main() {\n")
   +string(" vec2 uv =  v_vTexcoord.xy / 2.0 - vec2(0.0,0.5);\n")
   +string(" uv.y++;\n")
