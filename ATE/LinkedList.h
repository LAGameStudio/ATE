...
#define I_TILE(single)  TILEWORD(#single,single)
#define I_IMG(single)   IMGWORD(#single,single)
#define I_FILM(single)  FILMWORD(#single,single)
#define I_TWEEN(single) TWEENWORD(#single,single)
#define I_CSS(single)   TINTWORD(#single,single)
...
#define STRKEY(constcharstring,value)  { if (std::string(value).length()>0) _out+=constcharstring+string(" {")+value+string("}\n"); }
#define ZSTRKEY(constcharstring,zs)  { if (zs.value.length()>0) _out+=constcharstring+string(" {")+value+string("}\n"); }
