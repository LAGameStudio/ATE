...
public:
 ...
 bool inBounds(int i) { if (i >= 0 && i < (int) length) return true; else return false; }
 bool inBounds(int i, int j) { if (i >= 0 && i < (int)w && j >= 0 && j < (int)h) return true; else return false; }
