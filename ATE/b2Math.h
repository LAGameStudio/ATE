...
struct b2Transform
{
	...
	void Set(const b2Vec2& p, float angle)
	{
		position = p;
		R.Set(angle);
	}
...
struct b2Sweep
{
	...
	void GetTransform(b2Transform* xf, float alpha) const;
...
inline void b2Sweep::GetTransform(b2Transform* xf, float alpha) const
{
...
inline void b2Sweep::Advance(float t)
{
	c0 = (1.0f - t) * c0 + t * c;
	a0 = (1.0f - t) * a0 + t * a;
}
