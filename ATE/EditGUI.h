...
public:
 ...
 void ButtonFilmPick( const char *label, const char *named, Zp<Film> *f, int x, int y, int w=32, int h=32 );
 void ButtonFilmPick( const char *named, Zp<Film> *f, int x, int y, int w=32, int h=32 );
 void ButtonFilmPick( Zp<Film> *f, int x, int y, int w=32, int h=32 );
 void ButtonImageCartesians( const char *named, Cartesians *c, Zp<GLImage> *i, int x, int y, int w=92, int h=24 );
 void ButtonMulligan( const char *named, Mulligan *in, int x, int y, int w=32, int h=32 );
 void ButtonSound( const char *named, SoundEffect *in, Workspace *c, int x, int y, int w=32, int h=32 );
};
