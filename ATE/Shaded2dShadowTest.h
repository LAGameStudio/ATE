...
public:
 ...
 void Render() {
  ...
  glBegin(GL_QUADS);
  glTexCoord2f(0.0,1.0f); glVertex2f( 0.0f, 0.0f );
  glTexCoord2f(0.0,0.0f); glVertex2f( 0.0f, (float) fboScreen2.h );
  glTexCoord2f(1.0,0.0f); glVertex2i( fboScreen2.w, fboScreen2.h );
  glTexCoord2f(1.0,1.0f); glVertex2f( (float) fboScreen2.w, 0.0f );
  glEnd();
