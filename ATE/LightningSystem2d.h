...
//  dreamblurrgbShader.offset[0]=-(display->wf/100.0f);
//  dreamblurrgbShader.offset[1]=-(display->hf/100.0f);
...
//  rippleShader.pTex0=&fboScreen3.texture;
//  rippleShader.resolution[0]=256.0;
//  rippleShader.resolution[1]=256.0;
//  rippleShader.scale=64.0f;
//  rippleShader.UpdateUniforms();
  FullscreenQuadYInverted();
  bloomShader.Disable(); 
  fboScreen1.Unbind();
