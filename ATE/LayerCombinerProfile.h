...
class LayerCombinerTest : public GLWindow { 
 ...
 void Render() {
  ...
  layerCombiner.UpdateUniforms();
  Blending(additive);
  glBegin(GL_QUADS);
  glTexCoord2d(1.0, 1.0);  glVertex2d(quad.x2,quad.y);
  glTexCoord2d(0.0, 1.0);  glVertex2d(quad.x,quad.y);
  glTexCoord2d(0.0, 0.0);  glVertex2d(quad.x, quad.y2); 
  glTexCoord2d(1.0, 0.0);  glVertex2d(quad.x2,quad.y2);
  glEnd();
  layerCombiner.Disable();
  DebugOutput();
 }
};
...
public:
 ...
 void Render( double x, double y, double w2, double h2, double angle=0.0 ) {
  ...
  layerCombiner.UpdateUniforms();
  glBegin(GL_QUADS);
  glTexCoord2d(1.0, 1.0);  glVertex2d( w2, -h2);
  glTexCoord2d(0.0, 1.0);  glVertex2d(-w2, -h2);
  glTexCoord2d(0.0, 0.0);  glVertex2d(-w2,  h2); 
  glTexCoord2d(1.0, 0.0);  glVertex2d( w2,  h2); 
  glEnd();
  glPopMatrix();
  layerCombiner.Disable();
  Blending(none);
