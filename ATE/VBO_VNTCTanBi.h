...
class VBOStaticVNTCTanBi : public ModernVBO<VBO_VNTCTanBi> {
public:
 GLuint *position,*texcoord,*normal,*tangent,*bitangent,*color;
 void Constructor() {
  position=texcoord=normal=tangent=bitangent=color=nullptr;
 }
 ...
 void Set( VBO_VNTCTanBi *target, Vertex *source ) {
 ...
 void Get( VBO_VNTCTanBi *target, Vertex *source ) {
