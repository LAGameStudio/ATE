...
public:
 ...
 inline int Keypress( int code ) { return ( key_data[code] & 0x80 ) && !(prev_key_data[code] & 0x80) ? 1 : 0; }
 // Key Was Just Pressed
 inline int KeyPressed( int code ) { return ( key_data[code] & 0x80 ) && !(prev_key_data[code] & 0x80) ? 1 : 0; }
 // Key In Pressed State
 inline int KeyDown( int code ) { return ( key_data[code] & 0x80 ); }
 // Key Was Just Released
 inline int KeyUp( int code ) { return (( prev_key_data[code] & 0x80 ) && !( key_data[code] & 0x80 )) ? 1 : 0; }
 // Key Was Just Released
 inline int KeyReleased( int code ) { return (( prev_key_data[code] & 0x80 ) && !( key_data[code] & 0x80 )) ? 1 : 0; }
