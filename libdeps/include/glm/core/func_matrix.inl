...
namespace glm
{
	...
	)
    {
		...
		detail::tmat2x2<T> m(detail::tmat2x2<T>::_null);
		m[0][0] = c[0] * r[0];
		m[0][1] = c[1] * r[0];
		m[1][0] = c[0] * r[1];
		m[1][1] = c[1] * r[1];
	...
	)
    {
		...
		detail::tmat3x3<T> m(detail::tmat3x3<T>::_null);
	...
	)
    {
		...
		detail::tmat4x4<T> m(detail::tmat4x4<T>::_null);
	...
	)
	{
		...
		detail::tmat2x3<T> m(detail::tmat2x3<T>::_null);
		m[0][0] = c.x * r.x;
		m[0][1] = c.y * r.x;
		m[0][2] = c.z * r.x;
		m[1][0] = c.x * r.y;
	...
	)
	{
		...
		detail::tmat3x2<T> m(detail::tmat3x2<T>::_null);
		m[0][0] = c.x * r.x;
		m[0][1] = c.y * r.x;
		m[1][0] = c.x * r.y;
		m[1][1] = c.y * r.y;
	...
	)
	{
		...
		detail::tmat2x4<T> m(detail::tmat2x4<T>::_null);
		m[0][0] = c.x * r.x;
		m[0][1] = c.y * r.x;
		m[0][2] = c.z * r.x;
		m[0][3] = c.w * r.x;
	...
	)
	{
		...
		detail::tmat4x2<T> m(detail::tmat4x2<T>::_null);
		m[0][0] = c.x * r.x;
		m[0][1] = c.y * r.x;
		m[1][0] = c.x * r.y;
		m[1][1] = c.y * r.y;
	...
	)
	{
		...
		detail::tmat3x4<T> m(detail::tmat3x4<T>::_null);
		m[0][0] = c.x * r.x;
		m[0][1] = c.y * r.x;
		m[0][2] = c.z * r.x;
		m[0][3] = c.w * r.x;
	...
	)
	{
		...
		detail::tmat4x3<T> m(detail::tmat4x3<T>::_null);
		m[0][0] = c.x * r.x;
		m[0][1] = c.y * r.x;
		m[0][2] = c.z * r.x;
		m[1][0] = c.x * r.y;
	...
	)
    {
        ...
        detail::tmat2x2<T> result(detail::tmat2x2<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
        result[1][0] = m[0][1];
        result[1][1] = m[1][1];
	...
	)
    {
        ...
        detail::tmat3x3<T> result(detail::tmat3x3<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
        result[0][2] = m[2][0];
	...
	)
    {
        ...
        detail::tmat4x4<T> result(detail::tmat4x4<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
        result[0][2] = m[2][0];
        result[0][3] = m[3][0];
	...
	)
    {
        ...
        detail::tmat2x3<T> result(detail::tmat2x3<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
		result[0][2] = m[2][0];
        result[1][0] = m[0][1];
	...
	)
    {
        ...
        detail::tmat3x2<T> result(detail::tmat3x2<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
        result[1][0] = m[0][1];
        result[1][1] = m[1][1];
	...
	)
	{
		...
		detail::tmat2x4<T> result(detail::tmat2x4<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
		result[0][2] = m[2][0];
		result[0][3] = m[3][0];
	...
	)
	{
        ...
        detail::tmat4x2<T> result(detail::tmat4x2<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
        result[1][0] = m[0][1];
        result[1][1] = m[1][1];
	...
	)
	{
		...
		detail::tmat3x4<T> result(detail::tmat3x4<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
		result[0][2] = m[2][0];
		result[0][3] = m[3][0];
	...
	)
	{
        ...
        detail::tmat4x3<T> result(detail::tmat4x3<T>::_null);
        result[0][0] = m[0][0];
        result[0][1] = m[1][0];
		result[0][2] = m[2][0];
        result[1][0] = m[0][1];
	...
	)
	{
		...
		detail::tmat3x3<T> Inverse(detail::tmat3x3<T>::_null);
