...
/**
 * \brief Sets the Direct3D device to use for interoperability in this thread
 *
 * Records \p pD3D9Device as the Direct3D device to use for Direct3D
 ...
 * 
 *
 * Successful context creation on \p pD3D9Device will increase the internal
 * reference count on \p pD3D9Device. This reference count will be decremented
