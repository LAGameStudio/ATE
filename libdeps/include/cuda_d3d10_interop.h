...
/**
 * \brief Sets the Direct3D 10 device to use for interoperability in this thread
 *
 ...
 *
 * Successful context creation on \p pD3D10Device will increase the internal
 * reference count on \p pD3D10Device. This reference count will be decremented
 ...
 * ::cuD3D10ResourceGetMappedArray(). This option is only valid for resources
